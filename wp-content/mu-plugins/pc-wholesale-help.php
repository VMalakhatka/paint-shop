...
function pc_wholesale_help_render_endpoint(): void {
    ...
    <article class="pc-wholesale-help" id="pochatok">
        ...
        <section class="pc-help-section" id="katalog">
            ...
            <p><?php esc_html_e('On a phone, open Additional filters to choose supplier, unit, warehouses, availability or price. The active count stays visible when collapsed. Search, Apply filters and Reset remain available; collapsing does not clear your choices.', 'pc-wholesale-help'); ?></p>
