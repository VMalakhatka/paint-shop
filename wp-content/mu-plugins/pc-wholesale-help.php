...
function pc_wholesale_help_render_endpoint(): void {
    ...
    <article class="pc-wholesale-help" id="pochatok">
        ...
        <section class="pc-help-section" id="katalog">
            ...
            <p><?php esc_html_e('Empty branches and categories hidden by the shop do not appear in the menu. Parents remain when their available subcategories contain products. Out-of-stock products do not make a category empty.', 'pc-wholesale-help'); ?></p>
