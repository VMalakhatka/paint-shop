...
function pc_wholesale_help_render_endpoint(): void {
    ...
    <article class="pc-wholesale-help" id="pochatok">
        ...
        <section class="pc-help-section" id="katalog">
            ...
            <p><?php esc_html_e('Choose a unit of measure from the current category and its subcategories. Values come from the Folio product record and keep their original spelling; they are not pack quantities. Products without a synced unit remain available when All units is selected.', 'pc-wholesale-help'); ?></p>
