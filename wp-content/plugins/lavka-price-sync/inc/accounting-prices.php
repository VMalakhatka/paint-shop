...
add_action('admin_enqueue_scripts', function () {
    ...
    wp_localize_script('lps-accounting-price-campaign', 'LPS_ACCOUNTING_PRICE_CAMPAIGN', [
        ...
        'i18n' => [
            ...
            'stateReasons' => [
                'UNVERIFIED' => __('The product is present in the current Folio warehouse snapshot, but no successful accounting-price recalculation has been confirmed for it yet.', 'lavka-price-sync'),
            ...
            'zeroDenominatorExplanation' => __('The accounting formula denominator is zero. This SKU was rolled back and skipped; check the receipt price, document amount, tax data, and movement order in Folio.', 'lavka-price-sync'),
            'document' => __('Document', 'lavka-price-sync'),
            'problemDate' => __('Problem date', 'lavka-price-sync'),
            'initialQuantity' => __('Initial quantity', 'lavka-price-sync'),
            ...
            'shortage' => __('Shortage', 'lavka-price-sync'),
            'formula' => __('Formula', 'lavka-price-sync'),
            'numerator' => __('Numerator', 'lavka-price-sync'),
            'denominator' => __('Denominator', 'lavka-price-sync'),
            ...
            'allWarnings' => __('View warnings for all warehouses', 'lavka-price-sync'),
            ...
            'viewWarnings' => __('View warnings', 'lavka-price-sync'),
            ...
            'nextSafeRetry' => __('Next safe retry', 'lavka-price-sync'),
            'automaticLockRetries' => __('Automatic lock retries', 'lavka-price-sync'),
            'statusLabels' => [
                'IDLE' => __('Not started', 'lavka-price-sync'),
                'RUNNING' => __('Running', 'lavka-price-sync'),
                'COMPLETED' => __('Completed', 'lavka-price-sync'),
                ...
                'PAUSED_TIME_LIMIT' => __('Queue paused: insufficient time', 'lavka-price-sync'),
                'PARTIAL_TIME_LIMIT' => __('Partially processed: insufficient time', 'lavka-price-sync'),
                'NOT_PROCESSED_TIME_LIMIT' => __('Not processed: insufficient time', 'lavka-price-sync'),
                'MANUAL_REVIEW' => __('Manual review required', 'lavka-price-sync'),
                'FAILED_PARTIAL' => __('Failed after partial recalculation', 'lavka-price-sync'),
                'WAITING_RETRY' => __('Waiting to retry after Folio lock', 'lavka-price-sync'),
                'LOCK_RETRY_SCHEDULED' => __('Retry scheduled after Folio lock', 'lavka-price-sync'),
                'OUTCOME_UNKNOWN' => __('Outcome unknown', 'lavka-price-sync'),
            ...
            'phaseLabels' => [
                ...
                'WAITING_LOCK_RETRY' => __('Waiting before safe retry after Folio lock', 'lavka-price-sync'),
