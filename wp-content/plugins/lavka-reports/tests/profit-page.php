...
$page->render_page();
echo '<script>window.LavkaProfitReport=' . json_encode(['ajaxUrl' => 'https://profit.test/ajax', 'action' => 'test', 'nonce' => 'test', 'i18n' => $translation_method->invoke($page)]) . ';</script></body></html>';
