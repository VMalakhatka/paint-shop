...
- `Синхронізація цін → Сценарії аналітики` — общие и личные версионируемые
  сценарии для вкладок товаров и движений; первая версия использует один склад.
...
- Один сценарий хранит условия вкладок `Товари` и `Рух товару`, выбранный склад и
...
- Верхние summary cards пока относятся ко всему складу. Не подписывай их как
  итоги сценария до появления серверного пересчёта по общему контексту фильтров.
