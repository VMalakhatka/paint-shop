...
Проверено по активным плагинам и headers локального сайта: 2026-08-21. Перед изменением production сверяй `active_plugins` и MU-каталог.
...
| `paint-nova-poshta-multishipping` | прямая багатоскладська інтеграція Нової пошти; окремі shipment/ТТН, зовнішні B2B-ТТН; реальне створення ТТН до окремого підтвердження заблоковане |
