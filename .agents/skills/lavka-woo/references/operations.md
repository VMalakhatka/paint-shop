...
Проверено 2026-09-22: для ASCII-имён новых фото `ImageValidator::canonical_stem`
явно преобразует `КЦМ-` в `kcm-`, по назначенным production media. Это не меняет
SKU ФОЛИО/Woo и не переименовывает существующие S3/attachment objects. Не выводить
универсальную транслитерацию из этого частного правила.
