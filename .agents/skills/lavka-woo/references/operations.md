...
склад из stock scope и не включать в availability union. Код требует деплоя обеих
частей; сохранённые рабочие сценарии отдельно перевести на stock-only 15 после него.
