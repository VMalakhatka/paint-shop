...
1. Завантажте прайс під власним обліковим записом. За потреби відфільтруйте Excel
   за постачальником або категорією.
2. Впишіть потрібну кількість лише в **«Замовити»**. Не перейменовуйте шапку та
   ...
   Імпортуються всі заповнені рядки, у тому числі приховані фільтром Excel.
