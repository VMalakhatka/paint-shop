...
Функція доступна лише обраному тестовому клієнту. З 2026-09-13 підготовлено
фонові email: у списку позначте «Повідомляти мене email…» та збережіть налаштування.
