...
3. За потреби одночасно застосуйте пошук за назвою, артикулом або штрихкодом,
   ...
   **250мл** або **125мл**. Написання збережено без змін; це не кількість одиниць
   ...
   Товари згруповано за порядком постачальників, який задає магазин.
   ...
   На телефоні додаткові поля сховані під **«Додаткові фільтри»**:
   ...
   та скидання залишаються видимими. На комп’ютері поля відкриті.
