...
Функція з'являється після ввімкнення менеджером. Перший етап, реалізований
2026-09-12: повідомлення лише в кабінеті; публікація очікує deploy та перевірки.
...
показується як нуль. Перелік не резервує товари й не надсилає email.
