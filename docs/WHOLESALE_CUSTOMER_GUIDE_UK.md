...
Натисніть **«Завантажити доступну кількість у кошик»**. Сайт покаже таблицю:

- скільки було замовлено;
- скільки можна завантажити в кошик зараз;
- скільки залишиться у чернетці як відсутній товар.

Перевірка нічого не записує у ФОЛІО. Лише після окремого підтвердження сайт:
...
- створить для недоступного залишку необліковий документ ФОЛІО на налаштованому
  складі з позначкою «нет на складе»;
...
наприклад, передплачене замовлення товару, якого зараз немає. Після попереднього
перегляду й окремого підтвердження вся чернетка буде записана у ФОЛІО без руху
облікових залишків. Поточний кошик не зміниться.
