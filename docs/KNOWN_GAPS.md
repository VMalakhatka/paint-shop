...
Подневная доступность и группы логически общих складов пока не опубликованы в
schema v4. `coverageDays` нельзя использовать вместо процента доступности. Нужный
контракт, включая `MIN_TVRZAP=0`, описан в
