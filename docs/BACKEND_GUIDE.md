...
Проверено по коду отдельного worktree 2026-09-12; изолированные WordPress/MariaDB проверки прошли; production не проверен.
Владелец — `pc-order-import-export`: `Waitlist`, `WaitlistStore`, `WaitlistModel`.
...
Автоматическое погашение по покупкам, email и статистические рекомендации ещё не
реализованы. План и предложения по Java-проекциям —
